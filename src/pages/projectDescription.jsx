					...
					<div className="pd-main-container">
                        ...
                        <div className="left-project-container">
                            ...
                            <div className="tech-container pd-text">
                                ...
                                <p>
                                    <strong>Frontend:</strong> {INFO.projects[0].techStack.frontend} <br/>
                                    <strong>Logic & Algorithm:</strong> {INFO.projects[0].techStack.logicAlgorithm} <br/>
                                    <strong>Backend:</strong> {INFO.projects[0].techStack.backend} 
                                </p>
                            ...
                            <div className="feature-container pd-text">
                                ...
                                {INFO.projects[0].features.map((feature, index) => (
                                    <div className="feature-list list-points" key={index}>
                                        <ul>
                                            <li>{feature}</li>
                                        </ul>
                                    </div>
                            ...
                            <div className="challenges-container pd-text">
                                ...
                                {INFO.projects[0].challenges.map((challenge, index) => (
                                    <div className="challenge-list list-points" key={index}>
                                        <ul>
                                            <li><strong>{challenge.challenge}: </strong> {challenge.description}</li>
                                        </ul>
                                    </div>
                                ))}
                            </div>
                            ...
                            <div className="impact-container pd-text">
                                ...
                                {INFO.projects[0].impact.map((point, index) => (
                                    <div className="impact-list list-points" key={index}>
                                        <ul>
                                            <li>{point}</li>
                                        </ul>
                                    </div>
                        ...
                        <div className="right-project-container">
                            <video className="pd-vid" autoPlay loop muted>
                                <source src="nestmeet-demo.mp4" type="video/mp4"/>
                                Your browser does not support the video tag.
                            </video>

                            {INFO.projects[0].images.map((image, index) => (
                                <figure>
                                    <img className="pd-image img1" src={image.src} />
                            ...
                            <div className="demo-container pd-text">
                                ...
                                <div className="project-links">
                                    <Socials>
                                        <Socials.SocialIcon icon={faGithub} link={INFO.projects[0].gitRepo} label={"Link to Github Repo"} />
                                        <Socials.SocialIcon icon={faLink} link={INFO.projects[0].link} label={"Demo Link"} />
                                    </Socials>
						        </div>
                            </div>
                        </div>					
